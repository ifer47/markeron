export default {
  tools: {
    ...
    penCursorPen: 'Pen icon',
    penCursorDot: 'Dot',
    crosshairCursorCrosshair: 'Crosshair',
  ...
  toolDesc: {
    ...
    arrow: 'Arrow pointer line; press 3 again to switch crosshair / dot cursor',
    rect: 'Rectangle outline; press 4 again to switch crosshair / dot cursor',
    ellipse: 'Ellipse outline; press 5 again to switch crosshair / dot cursor',
    line: 'Straight line segment; press 6 again to switch crosshair / dot cursor',
    eraser: 'Stroke or object erase; press 7 again to switch',
  ...
  help: {
    ...
    eraserModeHint: 'With eraser selected, press 7 to switch stroke / object erase',
    penCursorHint: 'With pen selected, press 1 to switch pen icon / dot cursor',
    crosshairCursorHint: 'With a shape or laser selected, press its key again to switch crosshair / dot',
    editAndOther: 'Edit',
