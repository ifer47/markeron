export default {
  ...
  toolDesc: {
    ...
    arrow: '带箭头指示线；再按 3 切换十字准星 / 圆点光标',
    rect: '矩形边框；再按 4 切换十字准星 / 圆点光标',
    ellipse: '椭圆边框；再按 5 切换十字准星 / 圆点光标',
    line: '直线段；再按 6 切换十字准星 / 圆点光标',
    eraser: '轨迹 / 对象擦除；再按 7 切换模式',
    text: '双击放置，滚轮调字号',
  ...
  help: {
    ...
    mouseRightClickHold: '按住右键',
    whiteboardMode: '白板',
    toggleWhiteboard: '进入 / 退出',
    copyWhiteboard: '复制白板',
    exitWhiteboard: '退出白板',
    whiteboardPreserveHint: '',
    whiteboardContentHint: '',
    eraserModeHint: '选中橡皮擦后再按 7 可切换轨迹 / 对象擦除',
    penCursorHint: '选中画笔后再按 1 可切换钢笔图标 / 圆点光标',
    crosshairCursorHint: '选中形状或激光笔后再按对应数字可切换十字准星 / 圆点',
    editAndOther: '编辑',
    settingsPanel: '工具栏',
    toolbarOptionsHint: '',
    copyScreen: '复制屏幕',
